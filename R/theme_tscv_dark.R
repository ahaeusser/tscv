...
theme_tscv_dark <- function(base_size = 11,
  ...
  ggplot2::theme(
    ...
    axis.title.x =       ggplot2::element_text(
      ...
      vjust = 1, colour = "grey90"
    ),
    axis.title.x.top =   ggplot2::element_text(
      margin = ggplot2::margin(b = half_line / 2),
      vjust = 0, colour = "grey90"
    ),
    ...
    panel.grid =         ggplot2::element_line(color = "grey45"),
    ...
    strip.background =   ggplot2::element_rect(colour = "grey15", fill = "grey15"),
    ...
    plot.background =    ggplot2::element_rect(fill = "grey15"),
