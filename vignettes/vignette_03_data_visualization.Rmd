...
The package `tscv` provides a set of helper functions for time series analysis, forecasting and time series cross-validation. In addition to functions for splitting data and evaluating forecasts, the package contains several **visualization functions** that are useful for **exploratory data analysis**.
