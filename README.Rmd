...
- Wang, E., Cook, D., & Hyndman, R. J. (2020). *A new tidy data structure to support exploration and modeling of temporal data.* *Journal of Computational and Graphical Statistics*, 29(3), 466–478. [https://doi.org/10.1080/10618600.2019.1695624](https://doi.org/10.1080/10618600.2019.1695624)
- O'Hara-Wild, M., Hyndman, R., & Wang, E. (2026). *fable: Forecasting Models for Tidy Time Series.* R package. [https://fable.tidyverts.org/](https://fable.tidyverts.org/)
- O'Hara-Wild, M., Hyndman, R., & Wang, E. (2026). *fabletools: Core Tools for Packages in the 'fable' Framework.* R package. [https://fabletools.tidyverts.org/](https://fabletools.tidyverts.org/)
