...
Both approaches use the same forecast horizon and rolling-origin structure. The difference is how the training sample is updated:
...
After the splits have been created, they can be passed to the remaining `tscv` workflow: slice the training and test samples, estimate forecasting models, convert forecasts, and evaluate forecast accuracy.
