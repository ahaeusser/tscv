...
to visualize the four time series. The function
...
![Plot raw
data](vignette_02_cross_validation_files/figure-html/clean_data-1.png)
...
from a `tibble` to a `tsibble`. Due to the sample size and computation
time, only very simple benchmark methods are used:
...
The functions
[`SMEDIAN()`](https://ahaeusser.github.io/tscv/reference/SMEDIAN.md) and
[`SNAIVE2()`](https://ahaeusser.github.io/tscv/reference/SNAIVE2.md) are
...
![Plot accuracy by
horizon](vignette_02_cross_validation_files/figure-html/accuracy_horizon-1.png)
...
![Plot accuracy by
split](vignette_02_cross_validation_files/figure-html/accuracy_split-1.png)
